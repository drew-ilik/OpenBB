...
class ROUTER_econometrics(Container):
    ...
    def autocorrelation(
        ...
        y_column: Annotated[str, OpenBBField(description="")],
        x_columns: Annotated[list[str], OpenBBField(description="")],
        **kwargs: Any
    ) -> OBBject:
    ...
    def causality(
        ...
        y_column: Annotated[str, OpenBBField(description="")],
        x_column: Annotated[str, OpenBBField(description="")],
        lag: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 3,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cointegration(
        ...
        columns: Annotated[list[str], OpenBBField(description="")],
        **kwargs: Any
    ) -> OBBject:
    ...
    def correlation_matrix(
        ...
        method: Annotated[
            Literal["pearson", "kendall", "spearman"], OpenBBField(description="")
        ] = "pearson",
        chart: Annotated[
            bool,
            OpenBBField(
    ...
    def residual_autocorrelation(
        ...
        y_column: Annotated[str, OpenBBField(description="")],
        x_columns: Annotated[list[str], OpenBBField(description="")],
        lags: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 1,
        **kwargs: Any
    ) -> OBBject:
    ...
    def unit_root(
        ...
        column: Annotated[str, OpenBBField(description="")],
        regression: Annotated[
            Literal["c", "ct", "ctt"], OpenBBField(description="")
        ] = "c",
        **kwargs: Any
    ) -> OBBject:
    ...
    def variance_inflation_factor(
        ...
        columns: Annotated[Optional[list], OpenBBField(description="")] = None,
        **kwargs: Any
    ) -> OBBject:
        ...
        return self._run(
            "/econometrics/variance_inflation_factor",
            **filter_inputs(
                data=data,
                columns=columns,
                data_processing=True,
