...
class ROUTER_technical(Container):
    ...
    def ad(
        ...
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def adosc(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        fast: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 3,
        slow: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 10,
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def adx(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, OpenBBField(description="")] = 50,
        scalar: Annotated[float, OpenBBField(description="")] = 100.0,
        drift: Annotated[int, OpenBBField(description="")] = 1,
        chart: Annotated[
            bool,
            OpenBBField(
    ...
    def aroon(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, OpenBBField(description="")] = 25,
        scalar: Annotated[float, OpenBBField(description="")] = 100,
        chart: Annotated[
            bool,
            OpenBBField(
                description="Whether to create a chart or not, by default False."
    ...
    def atr(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 14,
        mamode: Annotated[
            Literal["rma", "ema", "sma", "wma"], OpenBBField(description="")
        ] = "rma",
        drift: Annotated[int, Ge(ge=0), OpenBBField(description="")] = 1,
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def bbands(
        ...
        target: Annotated[str, OpenBBField(description="")] = "close",
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, OpenBBField(description="")] = 50,
        std: Annotated[float, Ge(ge=0), OpenBBField(description="")] = 2,
        mamode: Annotated[
            Literal["sma", "ema", "wma", "rma"], OpenBBField(description="")
        ] = "sma",
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cci(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 14,
        scalar: Annotated[float, Gt(gt=0), OpenBBField(description="")] = 0.015,
        **kwargs: Any
    ) -> OBBject:
    ...
    def clenow(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        target: Annotated[str, OpenBBField(description="")] = "close",
        period: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 90,
        **kwargs: Any
    ) -> OBBject:
    ...
    def cones(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        lower_q: Annotated[float, OpenBBField(description="")] = 0.25,
        upper_q: Annotated[float, OpenBBField(description="")] = 0.75,
        model: Annotated[
            Literal[
                "std",
                "parkinson",
        ...
        is_crypto: Annotated[bool, OpenBBField(description="")] = False,
        trading_periods: Annotated[Optional[int], OpenBBField(description="")] = None,
        chart: Annotated[
            bool,
            OpenBBField(
                description="Whether to create a chart or not, by default False."
    ...
    def demark(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        target: Annotated[str, OpenBBField(description="")] = "close",
        show_all: Annotated[bool, OpenBBField(description="")] = True,
        asint: Annotated[bool, OpenBBField(description="")] = True,
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def donchian(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        lower_length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 20,
        upper_length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 20,
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def fib(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        close_column: Annotated[
            Literal["close", "adj_close"], OpenBBField(description="")
        ] = "close",
        period: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 120,
        start_date: Annotated[Optional[str], OpenBBField(description="")] = None,
        end_date: Annotated[Optional[str], OpenBBField(description="")] = None,
        **kwargs: Any
    ) -> OBBject:
    ...
    def fisher(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 14,
        signal: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 1,
        **kwargs: Any
    ) -> OBBject:
    ...
    def ichimoku(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        conversion: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 9,
        base: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 26,
        lagging: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 52,
        offset: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 26,
        lookahead: Annotated[bool, OpenBBField(description="")] = False,
        **kwargs: Any
    ) -> OBBject:
    ...
    def kc(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, Gt(gt=0), OpenBBField(description="")] = 20,
        scalar: Annotated[float, Gt(gt=0), OpenBBField(description="")] = 20,
        mamode: Annotated[
            Literal["ema", "sma", "wma", "hma", "zlma"], OpenBBField(description="")
        ] = "ema",
        offset: Annotated[int, Ge(ge=0), OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
    ...
    def macd(
        ...
        target: Annotated[str, OpenBBField(description="")] = "close",
        index: Annotated[str, OpenBBField(description="")] = "date",
        fast: Annotated[int, OpenBBField(description="")] = 12,
        slow: Annotated[int, OpenBBField(description="")] = 26,
        signal: Annotated[int, OpenBBField(description="")] = 9,
        chart: Annotated[
            bool,
            OpenBBField(
                description="Whether to create a chart or not, by default False."
    ...
    def relative_rotation(
        ...
        benchmark: Annotated[str, OpenBBField(description="")],
        study: Annotated[
            Literal["price", "volume", "volatility"], OpenBBField(description="")
        ] = "price",
        long_period: Annotated[Optional[int], OpenBBField(description="")] = 252,
        short_period: Annotated[Optional[int], OpenBBField(description="")] = 21,
        window: Annotated[Optional[int], OpenBBField(description="")] = 21,
        trading_periods: Annotated[Optional[int], OpenBBField(description="")] = 252,
        chart_params: Annotated[
            Optional[dict[str, Any]], OpenBBField(description="")
        ] = None,
        chart: Annotated[
            bool,
            OpenBBField(
    ...
    def rsi(
        ...
        target: Annotated[str, OpenBBField(description="")] = "close",
        index: Annotated[str, OpenBBField(description="")] = "date",
        length: Annotated[int, OpenBBField(description="")] = 14,
        scalar: Annotated[float, OpenBBField(description="")] = 100.0,
        drift: Annotated[int, OpenBBField(description="")] = 1,
        chart: Annotated[
            bool,
    ...
    def stoch(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        fast_k_period: Annotated[int, Ge(ge=0), OpenBBField(description="")] = 14,
        slow_d_period: Annotated[int, Ge(ge=0), OpenBBField(description="")] = 3,
        slow_k_period: Annotated[int, Ge(ge=0), OpenBBField(description="")] = 3,
        **kwargs: Any
    ) -> OBBject:
    ...
    def vwap(
        ...
        index: Annotated[str, OpenBBField(description="")] = "date",
        anchor: Annotated[str, OpenBBField(description="")] = "D",
        offset: Annotated[int, OpenBBField(description="")] = 0,
        **kwargs: Any
    ) -> OBBject:
